...
class Model(torch.nn.Module):
    ...
    def forward(self, pieces, mask):
        ...
        policy = policy[:self.n_pieces, :, :].transpose(0, 1) # (n_pieces, batch, hidden)
        ...
        value = torch.squeeze(torch.nn.functional.max_pool1d(value, self.n_pieces*2), 2) # (batch, hidden)
